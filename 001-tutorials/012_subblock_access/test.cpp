...
int main(int argc, const char *argv[]) {
  ...
  cxxopts::Options options("SubBlock Access Test",
                           "Test the SubBlock Access kernel");
  ...
  options.add_options()("help,h", "produce help message")(
      ...
      cxxopts::value<int>()->default_value("64"))(
      "Scols,S", "S, number of sub columns in the input matrix",
